const keyPointerCategories = [
  {
    ...
    pointers: [
      ...
      + "</tbody></table>",
      "<strong>Identity Protection roles:</strong> Requires Security Reader / Security Operator / Security Admin / Global Reader.",
      "<table style='width:100%;border-collapse:collapse;font-size:0.8rem;margin:0.25rem 0;'><thead><tr style='background:var(--primary-light,#f0f4ff);'><th style='padding:0.35rem 0.5rem;text-align:left;border:1px solid var(--border);'>Role</th><th style='padding:0.35rem 0.5rem;text-align:left;border:1px solid var(--border);'>Can do</th><th style='padding:0.35rem 0.5rem;text-align:left;border:1px solid var(--border);'>Can't do</th></tr></thead><tbody>"
      + "<tr><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'><strong>Security Admin</strong></td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Full access to Identity Protection</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Reset password</td></tr>"
      + "<tr><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'><strong>Security Operator</strong></td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>View all reports &amp; Overview, dismiss user risk, confirm safe/compromised</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Configure policies, reset password, configure alerts</td></tr>"
      + "<tr><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'><strong>Security Reader</strong></td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>View all reports &amp; Overview</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Configure policies, reset password, configure alerts, give feedback</td></tr>"
      + "</tbody></table>"
      + "Note: Security Operator can't access Risky sign-ins report. Conditional Access admins can create sign-in risk policies.",
      "<strong>Identity Protection licensing (requires Entra ID Premium P2):</strong>",
      "<table style='width:100%;border-collapse:collapse;font-size:0.8rem;margin:0.25rem 0;'><thead><tr style='background:var(--primary-light,#f0f4ff);'><th style='padding:0.35rem 0.5rem;text-align:left;border:1px solid var(--border);'>Capability</th><th style='padding:0.35rem 0.5rem;text-align:left;border:1px solid var(--border);'>Detail</th><th style='padding:0.35rem 0.5rem;text-align:left;border:1px solid var(--border);'>Free / M365 Apps</th><th style='padding:0.35rem 0.5rem;text-align:left;border:1px solid var(--border);'>P1</th><th style='padding:0.35rem 0.5rem;text-align:left;border:1px solid var(--border);'>P2</th></tr></thead><tbody>"
      + "<tr><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>User risk policy</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>via Identity Protection</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2718</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2718</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2714</td></tr>"
      + "<tr><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Sign-in risk policy</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>via Identity Protection or CA</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2718</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2718</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2714</td></tr>"
      + "<tr><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Overview</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Security reports overview</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2718</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2718</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2714</td></tr>"
      + "<tr><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Risky users</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Limited info without P2 (medium/high only, no details)</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>Limited</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>Limited</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>Full</td></tr>"
      + "<tr><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Risky sign-ins</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Limited info without P2 (no risk detail/level)</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>Limited</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>Limited</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>Full</td></tr>"
      + "<tr><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Risk detections</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>No access without P2</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2718</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>Limited</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>Full</td></tr>"
      + "<tr><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Users at risk alerts</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Notifications</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2718</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2718</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2714</td></tr>"
      + "<tr><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Weekly digest</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>Email notifications</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2718</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2718</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2714</td></tr>"
      + "<tr><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'>MFA registration policy</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);'></td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2718</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2718</td><td style='padding:0.3rem 0.5rem;border:1px solid var(--border);text-align:center;'>\u2714</td></tr>"
      + "</tbody></table>"
    ]
  },
  {
  ...
  },
  {
    ...
    pointers: [
      "<table style='width:100%;border-collapse:collapse;font-size:0.82rem;margin:0.25rem 0;'><thead><tr style='background:var(--primary-light, #f0f4ff);'><th style='padding:0.4rem 0.6rem;text-align:left;border:1px solid var(--border);'>If you need to&hellip;</th><th style='padding:0.4rem 0.6rem;text-align:left;border:1px solid var(--border);'>Report / Tool</th><th style='padding:0.4rem 0.6rem;text-align:left;border:1px solid var(--border);'>Where to find it</th></tr></thead><tbody>"
      + "<tr><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>See who did what</td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'><strong>Audit</strong></td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Microsoft Purview &rarr; Audit</td></tr>"
      + "<tr><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Search emails/documents for legal cases</td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'><strong>eDiscovery</strong></td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Microsoft Purview &rarr; eDiscovery</td></tr>"
      + "<tr><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Find sensitive data (credit cards, SSNs, etc.)</td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'><strong>Content Explorer</strong></td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Microsoft Purview &rarr; Information Protection &rarr; Content Explorer</td></tr>"
      + "<tr><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Review DLP violations</td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'><strong>DLP Reports</strong></td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Microsoft Purview &rarr; Data Loss Prevention</td></tr>"
      + "<tr><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Investigate risky employee behavior</td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'><strong>Insider Risk Management</strong></td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Microsoft Purview &rarr; Insider Risk Management</td></tr>"
      + "<tr><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Check compliance posture</td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'><strong>Compliance Manager</strong></td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Microsoft Purview &rarr; Compliance Manager</td></tr>"
      + "<tr><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Review data classifications and labels</td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'><strong>Information Protection</strong></td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Microsoft Purview &rarr; Information Protection</td></tr>"
      + "<tr><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Discover data assets and locations</td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'><strong>Data Map / Data Catalog</strong></td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Microsoft Purview Governance Portal</td></tr>"
      + "<tr><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Review retention policies</td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'><strong>Records Management</strong></td><td style='padding:0.35rem 0.6rem;border:1px solid var(--border);'>Microsoft Purview &rarr; Records Management</td></tr>"
      + "</tbody></table>"
      + "<div style='margin-top:0.5rem;padding:0.5rem;background:var(--primary-light, #f0f4ff);border-radius:6px;font-size:0.82rem;'><strong>One-Line Memory Aid</strong><br>Who? &rarr; Audit &bull; What sensitive data? &rarr; Content Explorer &bull; Who is risky? &rarr; Insider Risk &bull; Legal case? &rarr; eDiscovery &bull; Compliance score? &rarr; Compliance Manager</div>",
